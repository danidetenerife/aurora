...
const meta = {
  title: 'Remote/AuroraJam/SearchDrawer',
  component: AuroraJam.SearchDrawer,
  parameters: {
    layout: 'fullscreen',
    viewport: {
  ...
  tags: ['autodocs'],
} satisfies Meta<typeof AuroraJam.SearchDrawer>;
...
export const OpenAndClose = {
  render: () => (
    <JamFrame
      initialQuery=""
      drawer={
        <AuroraJam.SearchDrawer.Results>
          {results.map((resultTrack) => (
            <AuroraJam.SearchResultTrack
