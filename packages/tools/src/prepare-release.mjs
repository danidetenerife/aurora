...
const additionalVersionFiles = [
  [
    'packages/player/android/app/build.gradle',
    (content) =>
      content
  ...
  [
    'packages/player/src/stores/updaterStore.ts',
    (content) =>
      content.replace(
  ...
  [
    'packages/website/src/data/version.ts',
    (content) =>
      content.replace(
...
git(
  ...
  ...versionFiles,
  metainfoFile,
  ...additionalVersionFiles.map(([file]) => file),
);
