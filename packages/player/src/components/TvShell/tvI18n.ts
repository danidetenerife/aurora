...
tvI18n.addResourceBundle(
  ...
  'tv',
  {
    ...
    more: 'Mostrar más',
    podcasts: 'Podcasts',
    podcastEpisodes: 'Capítulos disponibles',
    playLatest: 'Reproducir último',
    addFavorite: 'Guardar favorito',
    inFavorites: 'En Favoritos',
    backToPodcasts: 'Volver a podcasts',
    loadErrorPodcasts: 'No se pudieron cargar los episodios.',
    retry: 'Reintentar',
    ...
    updateOpeningInstaller: 'Abriendo instalador…',
    updateFailed: 'Error al descargar la actualización',
  },
  true,
  true,
);
