  ...
  return (
    <button
      ...
      className={cn(
        ...
        sizeClasses[size],
        size === 'lg'
          ? 'bg-primary hover:bg-primary/90 text-zinc-950'
          : 'bg-zinc-800 text-white hover:bg-zinc-700',
        isActive && size !== 'lg' && 'text-primary bg-primary/20',
        focused && size === 'lg' && 'shadow-primary/30 scale-110 shadow-xl',
        focused && size !== 'lg' && 'ring-primary scale-110 ring-2',
      )}
    >
      {icon}
    </button>
...
export const TvNowPlayingBar: FC = () => {
  ...
  return (
    <div
      ...
      className="flex shrink-0 items-center gap-6 border-t border-zinc-800 bg-zinc-900/95 px-[5%] py-4 backdrop-blur-xl select-none"
    >
      ...
      <div className="flex flex-1 flex-col items-center gap-2">
        <div className="flex items-center gap-3">
          ...
          <TvControlButton
            ...
            onPress={playbackManager.toggle}
            size="lg"
