...
import { AuroraJamControls } from './AuroraJamControls';
...
describe('AuroraJamControls', () => {
  it('(Snapshot) renders the controls', () => {
    const { container } = render(<AuroraJamControls {...baseProps} />);
    expect(container).toMatchSnapshot();
  });

  it('shows elapsed time and remaining time counting down', () => {
    render(<AuroraJamControls {...baseProps} />);
  ...
  it('shows the play button when paused', () => {
    render(<AuroraJamControls {...baseProps} isPlaying={false} />);
  ...
  it('shows the pause button when playing', () => {
    render(<AuroraJamControls {...baseProps} isPlaying={true} />);
