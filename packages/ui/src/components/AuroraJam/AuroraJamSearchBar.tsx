...
export type AuroraJamSearchBarLabels = {
  placeholder: string;
};

export type AuroraJamSearchBarProps = {
  value: string;
  onChange: (value: string) => void;
  labels: AuroraJamSearchBarLabels;
  className?: string;
};

export const AuroraJamSearchBar: FC<AuroraJamSearchBarProps> = ({
  value,
  onChange,
  labels,
  className,
