...
import { pickArtwork, QueueItem } from '@aurora/model';

import { cn } from '../../utils';
import { Button } from '../Button';

type AuroraJamQueueItemProps = {
  item: QueueItem;
  isCurrent: boolean;
  onRemove?: () => void;
};

export const AuroraJamQueueItem = forwardRef<
  HTMLDivElement,
  AuroraJamQueueItemProps
...
AuroraJamQueueItem.displayName = 'AuroraJamQueueItem';
