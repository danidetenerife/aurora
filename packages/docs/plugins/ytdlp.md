...
The yt-dlp host is only configured when Aurora detects a working yt-dlp binary on the system. The `available` getter tells you whether you can use the API:
